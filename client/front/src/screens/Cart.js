                  ...
                  <div className="cart-collaterals">
                    ...
                    <form method="post" action="#" className="shipping_calculator">
                      ...
                      <section id="calcalute-shipping-wrap" className="shipping-calculator-form collapse">
                        ...
                        <p className="form-row form-row-wide"><input type="text" id="calc_shipping_state" name="calc_shipping_state" placeholder="State / county" defaultValue className="input-text" /> </p>
                        <p className="form-row form-row-wide"><input type="text" id="calc_shipping_postcode" name="calc_shipping_postcode" placeholder="Postcode / Zip" defaultValue className="input-text" /></p>
